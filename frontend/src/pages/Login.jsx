...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    if (clientId === 'your_google_client_id_here') {
      const mockEmail = prompt("Development Mode: Enter any Gmail address to simulate login:", "test@gmail.com");
      if (mockEmail) {
        setLoading(true);
    ...
    <div className="auth-page animate-fade-in">
      <div className="auth-card">
        <div className="auth-left">
          ...
          <div style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{ background: '#1e2538', color: 'white', padding: '1rem', borderRadius: '15px', marginTop: '1rem', border: '1px solid rgba(255,255,255,0.1)', maxWidth: '250px' }}>
              ...
              <p style={{ margin: '0.5rem 0 0 0', fontSize: '0.8rem', lineHeight: '1.4' }}>Sure, CreatorAI is ready to help you log in.</p>
            </div>
          </div>
        </div>
        <div className="auth-right">
          ...
          <h2 className="auth-title">Welcome to Sign In <span>CreatorAI!</span></h2>
